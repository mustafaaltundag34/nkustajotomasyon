<div class="modal fade" id="stoktakiler" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
							...
							<tr>
								...
								<form method="post" action="../netting/fatura.php">
									...
									<td>
										...
										<input type="hidden" name="durum" value="<?php echo $_GET['durum']; ?>">
										<button type="submit" class="btn btn-primary btn-sm" name="sepetEkle">Sepete Ekle</button> 
									</td> </form>
								</tr>
								<?php
							}
